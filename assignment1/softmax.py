# -*- coding: utf-8 -*-
"""
Created on Tue Aug 29 11:18:26 2017
...
best_val = -1
best_softmax = None
learning_rates = [0.5e-6, 1e-6, 5e-6]
regularization_strengths = [0.5e3, 1e3, 5e3]
...
for learning_rate in learning_rates:
    for reg in regularization_strengths:
        ...
        print('Regularization strength: %e , Learning rate : %e, Val accuracy: %f' % (reg, learning_rate, val_acc))

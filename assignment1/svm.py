# -*- coding: utf-8 -*-
"""
Created on Thu Aug 24 09:47:37 2017
...
regularization_strengths = [1.5e4, 2.5e4, 3.5e4]
...
for learning_rate in learning_rates:
    for regularization_strength in regularization_strengths:
      ...
      print('Regularization strength: %e , Learning rate : %e, Val accuracy: %f' % (regularization_strength, learning_rate, val_acc))
